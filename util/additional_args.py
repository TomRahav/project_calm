...
class AdditionalArguments:
    ...
    deploy_scenario: Optional[bool] = field(
        default=False,
        metadata={
            "help": ("Assume a deploying scneario for the accurate measurement.")
        },
    )
    use_synchronize: Optional[bool] = field(
        default=True,
        metadata={"help": ("Use synchronize when measuring the inference time.")},
    )
    ...
    output_hidden_states_decoder: Optional[bool] = field(
        ...
        metadata={
            "help": (
                "Output all hidden states in decoder model to train intermedidate layers."
            )
        },
    )
    intermediate_loss_fn: Optional[str] = field(
        default=None,
        metadata={
            "help": ("Choose the loss function to train intermediate layers as well.")
        },
    )
    distill_layer_alpha: Optional[float] = field(
        ...
        metadata={
            "help": (
                "Distillation interpolation hyperparameter between CrossEntropy and KL divergence."
            )
        },
    )
    do_layer_transformation: Optional[bool] = field(
        ...
        metadata={
            "help": (
                "Whether or not use transformation for student (shallow decoder) hidden states"
            )
        },
    )
    ...
    static_exit_layer: Optional[int] = field(
        ...
        metadata={
            "help": (
                "Choose an exit block for all tokens (i.e., exit tokens after [static_exit_layer] block)."
            )
        },
    )
    ...
    exit_conf_type: Optional[str] = field(
        default=None,
        metadata={"help": ("Select the type of confidence measure.")},
    )
    exit_conf_threshold: Optional[float] = field(
        default=1.0,
        metadata={"help": ("Default threshold value for early-exit framework.")},
    )
    exit_position_temp: Optional[float] = field(
        default=1,
        metadata={"help": ("Temperature value for decaying confidence threshold")},
    )
    exit_min_layer: Optional[int] = field(
        default=None,
        metadata={
            "help": (
                "To address unstable text generation and training, exit after certain layers."
            )
        },
    )
    train_meta_cm_head: Optional[bool] = field(
        ...
        metadata={
            "help": (
                "Train cm (confidence measure) head to align last hidden_states when exit_conf_type is set to meta."
            )
        },
    )
    # [tomr] added args
    exit_layers_temp: Optional[float] = field(
        default=1,
        metadata={
            "help": ("Temperature value for decaying layers confidence threshold")
        },
    )
    ...
    use_shallow_deep: Optional[bool] = field(
        default=False,
        metadata={"help": ("Use shallow-deep decoder framework in decoder model.")},
    )
    ...
    shallow2deep_conf_type: Optional[str] = field(
        ...
        metadata={
            "help": (
                "Select the type of confidence measure for chaning shallow to deep decoder."
            )
        },
    )
    shallow2deep_conf_threshold: Optional[float] = field(
        default=1.0,
        metadata={"help": ("Default threshold value in Shallow-Deep framework.")},
    )
    parallel_gen_token: Optional[bool] = field(
        default=True,
        metadata={
            "help": (
                "With the previous skipped tokens, generate the next token of Deep decoder in a non-autoregressive manner."
            )
        },
    )
    copy_skipped_hidden_states: Optional[bool] = field(
        ...
        metadata={
            "help": (
                "For the previous skipped tokens, copy hidden_states and generate key_value of Deep decoder."
            )
        },
    )
    parallel_causal_mask: Optional[bool] = field(
        ...
        metadata={
            "help": (
                "Using causal masking for sequence parallel computing when shallow2deep occurs."
            )
        },
    )
    rollback_conf_threshold: Optional[float] = field(
        ...
        metadata={
            "help": (
                "Default threshold value for RollBack policy in Shallow-Deep framework."
            )
        },
    )
    ...
    use_adapt_threshold: Optional[bool] = field(
        default=False,
        metadata={"help": ("Using adaptive threshold estimator for FREE framework.")},
    )

    # low rank adaptation
    use_lora: Optional[bool] = field(
        default=False,
        metadata={"help": ("Using low-rank adaptation for large language models")},
    )
    lora_rank: Optional[int] = field(
        default=8,
        metadata={"help": ("Default rank value of lora")},
    )
    lora_alpha: Optional[float] = field(
        default=8,
        metadata={"help": ("Default alpha value of lora")},
    )
...
def update_autoconfig(config, additional_args, **kwargs):
    ...
    if additional_args.train_meta_cm_head:
        assert additional_args.output_hidden_states_decoder
        assert (
            additional_args.intermediate_loss_fn is None
        )  # when training cm_head, model should be fully fine-tuned
